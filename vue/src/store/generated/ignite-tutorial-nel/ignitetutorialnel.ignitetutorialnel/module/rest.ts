 ...
 */
export interface IgnitetutorialnelQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: IgnitetutorialnelParams;
}
...
/**
 * @title ignitetutorialnel/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/ignite-tutorial-nel/ignitetutorialnel/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<IgnitetutorialnelQueryParamsResponse, RpcStatus>({
      path: `/ignite-tutorial-nel/ignitetutorialnel/params`,
      method: "GET",
      format: "json",
      ...params,
    });
